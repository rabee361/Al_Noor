...
urlpatterns = [
    ...
    path('customer_list/' , PilgrimListView.as_view() , name="customer_list"),
    path('add_customer/' , AddPilgrimView.as_view() , name="add_customer"),
    path('update_customer/' , UpdatePilgrimView.as_view() , name="update_customer"),
    path('provider_list/' , GuideListView.as_view() , name="provider_list"),
    path('add_provider/' , AddGuideView.as_view() , name="add_provider"),
    path('update_provider/' , UpdateGuideView.as_view() , name="update_provider"),
