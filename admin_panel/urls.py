...
urlpatterns = [
    ...
    path('add_manager/' , AddAdminView.as_view() , name="add_manager"),
    ...
    path('add_employee/' , AddGuideView.as_view() , name="add_employee"),
    path('update_employee/<str:pk>' , UpdateGuideView.as_view() , name="update_employee"),
    path('delete_employee/<str:pk>/' , delete_guide , name="delete_employee"),
